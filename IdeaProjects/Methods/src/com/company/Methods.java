/*In this program we will demonstrate how to use methods.
  The "static" keyword that is found in our methods below means that the methods belong to the "Main".
  It is important to note that the static keyword distinguishes each method from an object of the class.
  It shows that these are methods of the class "Main" and not objects of that class.
 */
